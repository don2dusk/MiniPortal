...
namespace MiniPortalv2
{
    ...
    public partial class usrDBEntities1 : DbContext
    {
        public usrDBEntities1()
            : base("name=usrDBEntities1")
        {
        }
        ...
        public virtual DbSet<tblProgramCours> tblProgramCourses { get; set; }
